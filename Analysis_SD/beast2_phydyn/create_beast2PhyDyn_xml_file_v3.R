...
eqns <- list(confeqn( 'beta1 = if (t!>1980) then 0.0 else (max(0.0, b1))',
                      type = 'definition'),
             confeqn( 'betalb = if (t!>1980) then 0.0
                      else if (t!>=1988.992) then beta1
                      else if (t!>=1997.986) then (beta1 * exp( dlogbeta[0]))
                      else if (t!>=2006.981) then (beta1 * exp( dlogbeta[0] + dlogbeta[1] ))
                      else (beta1 * exp( dlogbeta[0] + dlogbeta[1] +  dlogbeta[2]))',
                      type = 'definition'),
             confeqn('betaub = if (t!>1980) then 0.0
                     else if (t!>=1988.992) then (beta1 * exp( dlogbeta[0]))
                     else if (t!>=1997.986) then (beta1 * exp( dlogbeta[0] + dlogbeta[1]))
                     else if (t!>=2006.981 ) then (beta1 * exp( dlogbeta[0] + dlogbeta[1] + dlogbeta[2]))
                     else (beta1 * exp( dlogbeta[0] + dlogbeta[1] +  dlogbeta[2]))',
                     type = 'definition'),
             confeqn('tlb  = if (t!>1980) then 1980 else if (t!>=1997.986) then (1988.992) else if (t!>=2006.981) then (1997.986) else if (t!>=2015.975) then (2006.981) else (2015.975))',
                     type = 'definition'),
             confeqn('propub = max(0, min(1, (t-tlb)/ (2015.975 - 2006.981)))',
                     type = 'definition'),
