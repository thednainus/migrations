...
#in this model I am implementing a migration rate that varies with time
...
parms$srcMigrationRate.t <- function(t, p){
  approx( c(1980, 2020), c(0.01, p$srcMigrationRate) , xout = t, rule = 2)$y
}
