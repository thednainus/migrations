...
mcmc_results_iter.data1 <- mcmc_results_iter.data1[-c(14,15,19,23,27,38,40,42,43,45,49,4,9,18,16,17,50)]
length(mcmc_results_iter.data1)
mcmc_results_out1 <- mcmc_results1[grepl("out_sim.RDS", mcmc_results1)]
mcmc_results_out1 <- mcmc_results_out1[-c(14,15,19,23,27,38,40,42,43,45,49,4,9,18,16,17,50)]
length(mcmc_results_out1)

#run2
mcmc_results_iter.data2 <- mcmc_results2[grepl("iter.rdata", mcmc_results2)]
mcmc_results_iter.data2 <- mcmc_results_iter.data2[-c(14,15,19,23,27,38,40,42,43,45,49,4,9,18,16,17,50)]
length(mcmc_results_iter.data2)

mcmc_results_out2 <- mcmc_results2[grepl("out_sim.RDS", mcmc_results2)]
mcmc_results_out2 <- mcmc_results_out2[-c(14,15,19,23,27,38,40,42,43,45,49,4,9,18,16,17,50)]
