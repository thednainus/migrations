...
mcmc_results1 <- list.files("Analysis_SD/phydynR/mcmc_results/ICL_cluster/importation_rate/medium/region300global300/all_tree/run1/results", recursive = TRUE, full.names = TRUE)
mcmc_results2 <- list.files("Analysis_SD/phydynR/mcmc_results/ICL_cluster/importation_rate/medium/region300global300/all_tree/run2/results", recursive = TRUE, full.names = TRUE)
