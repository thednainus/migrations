...
# for fit2: provided incidence for SD until 2000 only
# for fit 3: provided incidence for SD until 1995 only (when first peak of
# incidence starts to decrease)
...
#up to where incidence goes to the minimum value before going up again
#change for fit 4
#incidence <- incidence[1:18,]
#change for fit 6
incidence <- incidence[1:parameters$line_incidence,]
