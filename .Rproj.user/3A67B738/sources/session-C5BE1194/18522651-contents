...
theta <- c(
  ...
  inc_scale = 0.03, # incidence scale (inc_scale): based on docking (see below) # initial = .03 # 0.09401734
...
date1 <- as.Date('2013-02-15')
times0 <- 0
times1 <- as.numeric( date1 - date0 )
times_year <- seq(year0, 2013.126, length.out = time_res) #to end of 2012
